...
import { 
  ...
  Calendar, DollarSign, Download, TrendingUp, TrendingDown,
  PieChart, FileText
} from 'lucide-react';
import { 
...
export const CashManager: React.FC<Props> = ({ data, onAddTransaction }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         ...
         <div className="bg-slate-900 rounded-[32px] p-8 text-white shadow-xl relative overflow-hidden flex flex-col justify-between group">
            <div className="relative z-10">
                ...
                <h2 className="text-5xl font-black tracking-tight tabular-nums">{totals.globalBalance.toLocaleString()}€</h2>
                <p className="text-[10px] font-bold text-slate-500 mt-2 uppercase tracking-widest">Disponible en Caja</p>
            </div>
