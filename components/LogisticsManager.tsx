  ...
  return (
    <div className="h-full flex flex-col gap-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 bg-white p-6 rounded-[32px] shadow-sm border border-slate-200">
         <div>
            <h2 className="text-2xl font-black text-slate-900 flex items-center gap-3"><Briefcase size={24} className="text-indigo-600"/> Gestión de Tareas</h2>
            <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">{tasks.filter(t => !t.isCompleted).length} Pendientes</p>
         </div>
      ...
      <div className="flex-1 overflow-hidden rounded-[40px] border border-slate-200 bg-slate-50/50 shadow-inner p-6 overflow-x-auto">
