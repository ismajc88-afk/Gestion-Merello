...
const App: React.FC = () => {
    ...
    const renderContent = () => {
        switch (currentView) {
            ...
            case 'settings-master': return <AdminControlPanel data={data} kioskConfig={data.kioskConfig} onUpdateConfig={c => updateData({ appConfig: c })} onUpdateKioskConfig={c => updateData({ kioskConfig: c })} onResetModule={actions.resetModule} onFullImport={setData} peerCount={peerCount} onClearAuditLog={() => updateData({ auditLog: [] })} />;
